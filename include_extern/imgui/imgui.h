...
struct ImDrawList
{
    ...
    IMGUI_API void  AddHex(const ImVec2& centre, float radius, ImU32 col, float thickness = 1.0f);
    IMGUI_API void  AddHexFilled(const ImVec2& centre, float radius, ImU32 col);
